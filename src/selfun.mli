...
val selection_fun : marked_reduction -> int
val selection_fun_redundant : marked_reduction -> int
val selection_fun_nostatechange : marked_reduction -> int
...
*)
val selection_with_ignore_nounif : (fact * marking) list -> ('a * int) list -> int * ('a * int) list
...
val find_inductive_variable_to_remove : (binder list -> 'a) -> marked_reduction -> 'a
