...
val sound_bad_derivable : Types.lemma list -> marked_reduction list -> marked_reduction list
...
val bad_derivable : t_horn_state -> marked_reduction list

val is_hypothesis_unsatisfiable : marked_reduction -> bool

val bad_in_saturated_database : unit -> bool

val bad_in_saturated_database_opt : unit -> marked_reduction option
