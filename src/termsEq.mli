...
val close_rule_eq : (marked_reduction -> unit) -> marked_reduction -> unit
val close_rule_hyp_eq : (marked_reduction -> unit) -> marked_reduction -> unit
...
val remove_syntactic_rule : marked_reduction -> marked_reduction
...
val simple_simplify_constraints_rule : marked_reduction -> marked_reduction
...
val simplify_constraints_rule : (marked_reduction -> unit) -> (marked_reduction -> unit) -> marked_reduction -> unit
